...
const RecognitionTemplate = ({ onClose, onTemplateSaved, formData: initialFormData = null, isReadOnly = false }) => {
...
• Mentored junior developers`,
  ...
  return (
    <div className="template-form-overlay">
      <div className="recognition-container" style={{ overflowY: 'auto', maxHeight: '90vh', scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
        <button 
          className="close-btn" 
          onClick={onClose}
          aria-label="Close"
