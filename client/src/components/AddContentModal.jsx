...
import { uploadContent, createLinkContent, createTemplateContent, getTemplates, getDepartments } from '../services/content';
...
const AddContentModal = ({ isOpen, onClose, onContentAdded, editMode = false, editContent = null }) => {
  ...
  const steps = [
    ...
    { number: 2, label: 'Assign Departments', icon: Users },
  ...
  useEffect(() => {
    if (isOpen) {
      console.log('🚀 MODAL OPENED - editMode:', editMode, 'editContent:', editContent);
      loadInitialData();
  ...
  const populateEditForm = () => {
    ...
    setFormData({
      ...
      templateType: editContent.templateType || '',
    });
  ...
  const handleNext = async () => {
    ...
    if (currentStep === 1) {
      ...
      if (contentType === 'template' && !formData.templateType) {
      ...
      if (editMode) {
        ...
        if (formData.file) {
          ...
          const updateData = {
            ...
            templateType: contentType === 'template' ? formData.templateType : undefined,
          };
        ...
        if (contentType === 'file') {
          ...
          response = await createTemplateContent({
            ...contentData,
        ...
        if (response && response.ok) {
          ...
          if (onContentAdded) {
            onContentAdded(response.content);
          }
          onClose();
          resetForm();
        } else {
      ...
      <DialogContent className={`overflow-y-auto ${
        ...
        {/* Step 1: Upload/Select Content */}
          ...
          <div className="space-y-6">
            ...
            {editMode && (
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <p className="text-sm text-blue-700">
                  ...
                  {contentType === 'template' && editContent?.templateType && (
                    <span className="ml-2">| Current template: <strong>{editContent.templateType}</strong></span>
                  )}
                </p>
                {/* Debug info */}
            ...
            {contentType === 'template' && (
              <div className="space-y-2">
                <label htmlFor="templateType" className="block text-base font-medium text-gray-700">
                  {editMode ? 'Update Template Type' : 'Template Type *'}
                </label>
                <select
                  id="templateType"
                ...
                {formData.templateType && (
                  <div className="mt-3 p-3 bg-blue-50 rounded-lg">
                    <p className="text-sm text-blue-800">
                      {availableTemplates.find(t => t.id === formData.templateType)?.description}
                    </p>
                  </div>
                          )}
                        </div>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500">
                        Select all departments at once
                      </p>
                    </div>
                  </div>
              ...
              {formData.ackRequired && (
                <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <p className="text-base font-medium text-green-900">Acknowledgment Required</p>
                  </div>
        ...
        {currentStep === 5 && (
          <div className="space-y-6">
            ...
            <div className="space-y-4 p-6 bg-gray-50 rounded-xl">
              ...
              <div>
                <p className="text-base text-gray-600">Acknowledgment Required</p>
                <p className="font-medium text-lg text-gray-900">
