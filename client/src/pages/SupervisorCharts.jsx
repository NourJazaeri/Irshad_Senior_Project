...
export default function SupervisorCharts() {
  ...
  return (
    <div id="supervisor-dashboard-root" className="p-6 md:p-10 bg-gray-50 min-h-screen">
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          {/* Row 4: Content Performance - Full Width */}
          <div className="bg-white rounded-xl shadow p-8">
            <ContentPerformanceChart contentPerformance={dashboard.contentPerformance} />
          </div>

          {/* Row 5: Trainee Progress Table - Full Width */}
          <div className="bg-white rounded-xl shadow p-8">
