...
const ContentView = () => {
    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => navigate('/admin/content')} className="bg-primary hover:bg-primary-hover">
  ...
  return (
    <div className="h-full">
      {/* Content Viewer - Fills the entire area under the unified top bar */}
      <div className="h-full w-full" style={{ height: '100%', width: '100%' }}>
        <div 
          ...
          className="fullscreen-content-viewer"
        >
          {/* Content Title */}
          {content && (
            <div className="w-full px-8 py-6 bg-card border-b border-border">
