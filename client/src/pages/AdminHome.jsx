...
export default function AdminHome() {
  ...
  const fetchCompanyId = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/company-profile/me", {
        headers: authHeaders(),
      });
  ...
  const renameDepartment = async () => {
    ...
    try {
      await axios.put(
        `http://localhost:5000/api/departments/${renameModal._id}`,
  ...
  const deleteDepartment = async () => {
    ...
    try {
      await axios.delete(
        `http://localhost:5000/api/departments/${deleteModal._id}`,
        { headers: authHeaders() }
      );
      setDeleteModal(null);
      fetchDepartments();
            ...
            >
              ...
              >
                <h3
                  ...
                  onClick={() =>
                    window.location.assign(`/admin/departments/${dept._id}`)
                  }
                >
                  {dept.departmentName}
                </h3>
