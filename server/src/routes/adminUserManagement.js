...
// TEST ROUTE - Simple admin auth test
...
router.get('/employees', authenticateAdmin, async (req, res) => {
  try {
    ...
    console.log('Admin ID from auth:', req.admin.id);
    
    // Get admin's company ID
    const companyId = await getAdminCompany(req.admin.id);
...
router.get('/trainees', authenticateAdmin, async (req, res) => {
  try {
...
router.get('/supervisors', authenticateAdmin, async (req, res) => {
  try {
...
router.get('/employees/:id', authenticateAdmin, async (req, res) => {
  try {
...
router.get('/trainees/:id', authenticateAdmin, async (req, res) => {
  try {
...
router.get('/supervisors/:id', authenticateAdmin, async (req, res) => {
  try {
...
router.get('/company-info', authenticateAdmin, async (req, res) => {
  try {
    console.log('Fetching company info for admin:', req.admin.id);
...
router.get('/employee-type/:employeeId', authenticateAdmin, async (req, res) => {
  try {
...
router.delete('/trainees/by-employee/:employeeId', authenticateAdmin, async (req, res) => {
  try {
    const { employeeId } = req.params;
...
router.delete('/supervisors/by-employee/:employeeId', authenticateAdmin, async (req, res) => {
  try {
    const { employeeId } = req.params;
